...
class TestModelRegionSet(unittest.TestCase):
    def setUp(self):
        ...
        self.X_test = pd.DataFrame([
            ...
            [10, 1],
            [20, 2],
        ], columns=['var1', 'var2'], index=range(5, 10))
        ...
        self.region_set = ModelRegionSet(self.X, self.y, self.X_test, self.y_test, self.model, lambda *args: 1)
        self.problem_category = ProblemCategory.regression

    def test_left_out(self):
        self.region_set.left_out_region.train_substitution_models(task_type=self.problem_category)
